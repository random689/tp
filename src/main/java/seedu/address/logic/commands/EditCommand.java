...
public class EditCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person editedPerson = createEditedPerson((Student) personToEdit, editPersonDescriptor);
    ...
    private static Person createEditedPerson(Student personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        return new Student(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags, updatedEmergencyContact);
    }

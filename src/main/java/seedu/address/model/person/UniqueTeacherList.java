 ...
 * A teacher is considered unique by comparing using {@code Teacher#isSameTeacher(teacher)}. As such, adding and updating of
 * teacher uses Teacher#isSameTeacher(Teacher) for equality so as to ensure that the teacher being added or updated is
 * unique in terms of identity in the UniqueTeacherList. However, the removal of a teacher uses Teacher#equals(Object) so

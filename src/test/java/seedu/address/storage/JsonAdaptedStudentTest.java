...
public class JsonAdaptedStudentTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, VALID_GENDER,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, VALID_GENDER, VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_invalidInvolvement_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, VALID_GENDER,
                        VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_nullInvolvement_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, VALID_GENDER, VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_INVOLVEMENT, VALID_TAGS, INVALID_PHONE, VALID_FORM_CLASS, VALID_GENDER,
                        VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_nullEmergencyContact_throwsIllegalValueException() {
        ...
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_INVOLVEMENT, VALID_TAGS, null, VALID_FORM_CLASS, VALID_GENDER,
                        VALID_MEDICAL_HISTORY);
        assertThrows(IllegalValueException.class, student::toModelType);
    }
    ...
    public void toModelType_invalidFormClass_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, INVALID_FORM_CLASS, VALID_GENDER,
                        VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_nullFormClass_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, null, VALID_GENDER, VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedStudent student =
                new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, INVALID_GENDER,
                        VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_nullGender_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, null, VALID_MEDICAL_HISTORY);
    ...
    public void toModelType_nullMedicalHistory_throwsIllegalValueException() {
        JsonAdaptedStudent student = new JsonAdaptedStudent(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_INVOLVEMENT, VALID_TAGS, VALID_PHONE, VALID_FORM_CLASS, VALID_GENDER, null);

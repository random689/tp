...
import static seedu.address.commons.core.Messages.MESSAGE_INVALID_TEACHER_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @Test
    public void execute_studentCommandExecutionError_throwsCommandException() {
        String deleteCommand = "deleteStudent 9";
        assertCommandException(deleteCommand, MESSAGE_INVALID_STUDENT_DISPLAYED_INDEX);
    }

    @Test
    public void execute_teacherCommandExecutionError_throwsCommandException() {
        String deleteCommand = "deleteTeacher 9";
        assertCommandException(deleteCommand, MESSAGE_INVALID_TEACHER_DISPLAYED_INDEX);
    }
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage,
        ...
        CommandResult result = logic.execute(inputCommand, Window.MAIN);
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        assertThrows(expectedException, expectedMessage, () -> logic.execute(inputCommand, Window.MAIN));
        assertEquals(expectedModel, model);
    }

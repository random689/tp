...
public class StudentCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB , new StudentCommand(expectedPerson));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                        + INVOLVEMENT_DESC_AMY + EMERGENCY_CONTACT_DESC_AMY + FORM_CLASS_DESC_AMY,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                ...
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVOLVEMENT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + INVOLVEMENT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC
                + INVOLVEMENT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Address.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVOLVEMENT_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Tag.MESSAGE_CONSTRAINTS);

        // invalid involvement
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_INVOLVEMENT_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + FORM_CLASS_DESC_BOB, Involvement.MESSAGE_CONSTRAINTS);

        // invalid form class
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVOLVEMENT_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + EMERGENCY_CONTACT_DESC_BOB + INVALID_FORM_CLASS_DESC, FormClass.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + INVOLVEMENT_DESC_BOB + EMERGENCY_CONTACT_DESC_BOB
                + FORM_CLASS_DESC_BOB, Name.MESSAGE_CONSTRAINTS);

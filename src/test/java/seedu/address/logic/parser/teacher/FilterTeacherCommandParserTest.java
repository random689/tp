...
public class FilterTeacherCommandParserTest {
    ...
    public void parse_emptyArg_throwsParseException() {
        assertParseFailure(parser, "     ", String.format(MESSAGE_INVALID_COMMAND_FORMAT, FilterTeacherCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_validArgs_returnsFilterCommand() {
        ...
        FilterTeacherCommand expectedFilterCommand =
                new FilterTeacherCommand(new TeacherInvolvementContainsKeywordsPredicate(Arrays.asList("Alice", "Bob")));
